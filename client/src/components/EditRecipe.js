...
import { getCuisineQuery, getMealCuisinePivotQuery, getMealQuery, updateRecipeMutation } from "../queries/query";
class EditRecipe extends Component {
  ...
  async onSubmitForm(e) {
    ...
    let variables = {
      meal_id: this.state.selected_meal_id,
      cuisine_id: this.state.selected,
      id: this.props.recipe.id
    }
    console.log('variables', variables)
    await this.props.updateRecipeMutation(
      {
        variables,
